...
public class ArraysDemo {
    ...
    public static void main(String[] args){
        ...
        if we try to store a new value previous value is overriden by the latest value
        to overcame this issues java has Arrays in arrays we can store multiplr balue using a single array type
         */
